    ...
    <section className="w-full py-16 sm:py-20 lg:py-24">
      <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="max-w-md text-sm leading-7 text-muted-foreground sm:text-base md:pb-1 md:text-right">
        ...
        {/* Benefits */}
        <div className="mt-10 overflow-hidden rounded-xl border border-border sm:mt-12">
